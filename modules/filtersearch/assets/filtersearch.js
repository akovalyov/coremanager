...
$(function () {
    if (window.productCount) {
        window.animationSpeed = 500,
            window.limitTimeout = 200,
            window.filterCount = productCount,
            window.responder = modulePath() + 'modules/filtersearch/filtersearch.json.php',
            window.filterList = [],
            window.nArray = [],
            window.orderBy = 'newest',
            window.orderWay = 'desc',
            window.plural = '',
            window.pagerClone,
            window.sortObj,
